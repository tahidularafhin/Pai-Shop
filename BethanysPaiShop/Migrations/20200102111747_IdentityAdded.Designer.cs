...
namespace BethanysPaiShop.Migrations
{
    ...
    [Migration("20200102111747_IdentityAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BethanysPaiShop.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("BethanysPaiShop.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("BethanysPaiShop.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("BethanysPaiShop.Models.Pie", b =>
                {
                    b.Property<int>("PieId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BethanysPaiShop.Models.ShoppingCartItem", b =>
                {
            ...
            modelBuilder.Entity("BethanysPaiShop.Models.OrderDetail", b =>
                {
                    b.HasOne("BethanysPaiShop.Models.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BethanysPaiShop.Models.Pie", "Pie")
                        .WithMany()
                        .HasForeignKey("PieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BethanysPaiShop.Models.Pie", b =>
                {
                    b.HasOne("BethanysPaiShop.Models.Category", "Category")
                        .WithMany("Pies")
